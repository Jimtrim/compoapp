...
?>    
    <div data-role="footer" data-position="fixed">
      <div data-role="navbar">
        <ul>
          <li><a href="#home" data-icon="home" <?php if ("home" == $active) { echo ' class="ui-btn-active ui-state-persist"'; }
          											else { echo' data-rel="back"'; } ?>>Hjem</a></li>
          <li><a href="#description" data-icon="info" <?php if ("description" == $active) { echo ' class="ui-btn-active ui-state-persist"'; }
          											else if ("highscore" == $active) { echo' data-rel="back"'; } ?>>Beskrivelse</a></li>
